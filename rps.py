...
button2 = tk.Button(text="      Cutting can be done to Paper      ",bg="pink",command=paper)
button2.grid(column=0,row=2)
button3 = tk.Button(text="      It is use to cut Scissor     ",bg="lightgreen",command=scissor)
